...
export function useTranscription(): UseTranscriptionReturn {
  ...
  /**
   * Procesa el audio grabado: envía al backend y recibe solo transcripción
   */
  const processAudio = async () => {
    try {
      ...
      // Enviar al backend (endpoint solo de transcripción)
      console.log('📤 Enviando audio al backend para transcripción...');
      const response = await fetch(`${API_URL}/api/openai/transcribe-only`, {
        method: 'POST',
        headers: {
